					...
					success: function(data){
						...
						if(status == 0){
							...
							for(var o in myCreatedEvents){
								...
								tempLocation = tempLocation.split(":")[1];
								if(tempLocation == undefined){
									tempLocation = tempEO["location"].split(":")[0];
								}
					...
					success: function(data){
						...
						if(status == 0){
							...
							for(var o in friendEvents){
								...
								teLocation = teLocation.split(":")[1];
								if(teLocation == undefined){
									teLocation = tempE["location"].split(":")[0];
								}
								if(teLocation.length > 15){
									teLocation = teLocation.substring(0,15) + "...";
								}
													...
													<div class="thumbnail mytopbuffer">\
														...
														<div class="row">\
															<div class="col-xs-6">\
																...
																<div class="checkbox myzerotop"><label>\
																	<input id="entertainmentsCB" value="Entertainments" type="checkbox" onchange="launchSettingUpdateBtn()"><font size="2">Entertainment</font>\
																</label></div>\
															</div>\
															<div class="col-xs-6">\
																<div class="checkbox myzerotop"><label>\
																...
																<div class="checkbox myzerotop"><label>\
																	<input id="healthyCB" value="Healthy Care" type="checkbox" onchange="launchSettingUpdateBtn()"><font size="2">Health Care</font>\
																</label></div>\
																<div class="checkbox myzerotop"><label>\
																	<input id="kitchenCB" value="Kitchen" type="checkbox" onchange="launchSettingUpdateBtn()"><font size="2">Kitchenware</font>\
																</label></div>\
																<div class="checkbox myzerotop"><label>\
